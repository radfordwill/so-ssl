...
= 1.4.4 =
This version includes an improved user interface design with enhanced navigation and styling. The update provides a more intuitive experience while configuring security settings.

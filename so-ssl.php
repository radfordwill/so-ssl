 ...
 */
function so_ssl_add_csp_frame_ancestors_header() {
...
add_action('send_headers', 'so_ssl_add_csp_frame_ancestors_header');

/**
 * Add CSP Frame-Ancestors settings to plugin settings page.
 */
function so_ssl_csp_settings() {
    ...
    add_settings_field(
        ...
        'so_ssl_enable_csp_frame_ancestors_callback',
        'so-ssl',
        'so_ssl_csp_section'
    );
    ...
    add_settings_field(
        ...
        'so_ssl_csp_frame_ancestors_option_callback',
        'so-ssl',
        'so_ssl_csp_section'
    );
    ...
    add_settings_field(
        ...
        'so_ssl_csp_include_self_callback',
        'so-ssl',
        'so_ssl_csp_section',
    ...
    add_settings_field(
        ...
        'so_ssl_csp_frame_ancestors_domains_callback',
        'so-ssl',
        'so_ssl_csp_section',
        array('class' => 'so_ssl_csp_custom_field')
    );
    
    // Add JavaScript to show/hide the custom CSP fields based on selected option
    add_action('admin_footer', 'so_ssl_csp_admin_footer_js');
}
add_action('admin_init', 'so_ssl_csp_settings');

/**
 * Add JavaScript to show/hide the custom CSP fields
 */
function so_ssl_csp_admin_footer_js() {
    ?>
    <script>
    jQuery(document).ready(function($) {
 ...
 */
function so_ssl_csp_section_callback() {
 ...
 */
function so_ssl_enable_csp_frame_ancestors_callback() {
 ...
 */
function so_ssl_csp_frame_ancestors_option_callback() {
    $csp_option = get_option('so_ssl_csp_frame_ancestors_option', 'none');
 ...
 */
function so_ssl_csp_include_self_callback() {
 ...
 */
function so_ssl_csp_frame_ancestors_domains_callback() {
 ...
 */
function update_so_ssl_activation() {
    // Add the new CSP options with defaults during activation
...
// Update the activation hook to include the new settings
register_activation_hook(__FILE__, 'activate_so_ssl');
add_action('activate_so_ssl', 'update_so_ssl_activation');
